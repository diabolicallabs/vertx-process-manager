...
*/
public class ProcessInstanceServiceVertxProxyHandler extends ProxyHandler {
  ...
  public ProcessInstanceServiceVertxProxyHandler(Vertx vertx, ProcessInstanceService service) {
    this(vertx, service, DEFAULT_CONNECTION_TIMEOUT);
  }

  public ProcessInstanceServiceVertxProxyHandler(Vertx vertx, ProcessInstanceService service, long timeoutInSecond) {
    this(vertx, service, true, timeoutInSecond);
  }

  public ProcessInstanceServiceVertxProxyHandler(Vertx vertx, ProcessInstanceService service, boolean topLevel, long timeoutSeconds) {
    this.vertx = vertx;
