...
*/
public class KnowledgeServiceFactoryVertxProxyHandler extends ProxyHandler {

  public static final long DEFAULT_CONNECTION_TIMEOUT = 5 * 60; // 5 minutes 

  private final Vertx vertx;
  private final KnowledgeServiceFactory service;
  private final long timerID;
  private long lastAccessed;
  private final long timeoutSeconds;

  public KnowledgeServiceFactoryVertxProxyHandler(Vertx vertx, KnowledgeServiceFactory service) {
    this(vertx, service, DEFAULT_CONNECTION_TIMEOUT);
  }

  public KnowledgeServiceFactoryVertxProxyHandler(Vertx vertx, KnowledgeServiceFactory service, long timeoutInSecond) {
    this(vertx, service, true, timeoutInSecond);
  }

  public KnowledgeServiceFactoryVertxProxyHandler(Vertx vertx, KnowledgeServiceFactory service, boolean topLevel, long timeoutSeconds) {
    this.vertx = vertx;
        ...
        case "getKnowledgeService": {
          service.getKnowledgeService(res -> {
            if (res.failed()) {
              ...
              ProxyHelper.registerService(KnowledgeService.class, vertx, res.result(), proxyAddress, false, timeoutSeconds);
