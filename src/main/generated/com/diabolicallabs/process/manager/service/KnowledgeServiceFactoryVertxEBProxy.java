...
*/
public class KnowledgeServiceFactoryVertxEBProxy implements KnowledgeServiceFactory {
  ...
  public KnowledgeServiceFactoryVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public KnowledgeServiceFactoryVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  public KnowledgeServiceFactory getKnowledgeService(Handler<AsyncResult<KnowledgeService>> handler) {
    ...
    _vertx.eventBus().<KnowledgeService>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        ...
        handler.handle(Future.succeededFuture(ProxyHelper.createProxy(KnowledgeService.class, _vertx, addr)));
      }
    });
    return this;
  }
