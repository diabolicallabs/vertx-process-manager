...
public class knowledgeService_ implements ReifiedType {

  private static final knowledgeService_ instance = new knowledgeService_();
  public static final TypeDescriptor $TypeDescriptor$ = TypeDescriptor.klass(knowledgeService_.class);
  ...
  public static knowledgeService_ get_() {
    return instance;
  }
